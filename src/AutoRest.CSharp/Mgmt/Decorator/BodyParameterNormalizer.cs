...
namespace AutoRest.CSharp.Mgmt.Decorator
{
    internal static class BodyParameterNormalizer
    {
        ...
        internal static void UpdateUsingReplacement(RequestParameter bodyParameter, IReadOnlyDictionary<string, HashSet<OperationSet>> resourceDataDictionary)
        {
        ...
        internal static void UpdateParameterNameOnly(RequestParameter bodyParam, IReadOnlyDictionary<string, HashSet<OperationSet>> resourceDataDictionary)
        {
